...
public void setPatient(CDALDOPatient patient) {
    ...
    if (!(patientCF && patientEni)) throw new IllegalArgumentException("atleast one id needs to be a Codice Fiscale or an ENI code");
    if(!patientAna) throw new IllegalArgumentException("an id need to be an ANA code");
    if (patient.getLastName() == null || patient.getFirstName() == null || patient.getBirthDate() == null || patient.getBirthPlace() == null || patient.getGender() == null){
...
public void setAuthor(CDALDOAuthor author) {
    ...
    if (author.getId().getOid() =="2.16.840.1.113883.2.9.4.3.2") throw new IllegalArgumentException("author id needs to be a CF");
    this.author = author;
...
public void setGuardian(CDALDOPatient guardian) {
    ...
    if (!guardianCF) throw new IllegalArgumentException("at least one id needs to be a Codice Fiscale");
    if (guardian.getLastName() == null || guardian.getFirstName() == null || guardian.getBirthDate() == null || guardian.getBirthPlace() == null || guardian.getGender() == null) {
...
public void setCompiler(CDALDOAuthor compiler) {
    ...
    if (compiler.getId().getOid() =="2.16.840.1.113883.2.9.4.3.2") throw new IllegalArgumentException("compiler id needs to be a CF");
    this.compiler = compiler;
    this.compilerTime = LocalDateTime.now();
}
public void setCustodian(CDALDOId custodianId, String custodianOrgazationName, CDALDOAddr custodianOrganizationAddress, String custodianPhoneNumber) {
    if (custodianId == null) {
    ...
    if(!(custodianId.getOid().equals("2.16.840.1.113883.2.9.4.1.1")||custodianId.getOid().equals("2.16.840.1.113883.2.9.4.1.2"))){
...
public void setComponentOf(String ramoAziendale, String numeroNosologico, String nomeAzienda, LocalDateTime lowTime, LocalDateTime highTime, List<String> repartoIds, List<String> repartoNames, List<String> ministerialCodes, List<String> facilityNames, List<String> facilityTelecoms) {
...
public List<String> check(){
    ...
    if(this.oid == null) errors.add("oid");
    if(this.status == null) errors.add("status");
    if(this.effectiveTimeDate == null) errors.add("effectiveTimeDate");
    if(this.setOid == null) errors.add("setOid");
    if(this.versionNumberValue == null) errors.add("versionNumberValue");
    if(this.patient == null) errors.add("patient");
    if(this.author == null) errors.add("author");
    if(this.authorTime == null) errors.add("authorTime");
    if(this.rapresentedOrganization == null) errors.add("rapresentedOrganization");
    if(this.compiler == null) errors.add("compiler");
    if(this.compilerTime == null) errors.add("compilerTime");
    if(this.custodianId == null) errors.add("custodianId");
    ...
    if(this.ramoAziendale == null) errors.add("ramoAziendale");
    if(this.numeroNosologico == null) errors.add("numeroNosologico");
    if(this.nomeAzienda == null) errors.add("nomeAzienda");
    if(this.lowTime == null) errors.add("lowTime");
    if(this.highTime == null) errors.add("highTime");
    if(this.repartoIds == null || this.repartoIds.isEmpty()) errors.add("repartoIds");
    if(this.repartoNames == null || this.repartoNames.isEmpty()) errors.add("repartoNames");
    if(this.ministerialCodes == null || this.ministerialCodes.isEmpty()) errors.add("ministerialCodes");
    if(this.facilityNames == null || this.facilityNames.isEmpty()) errors.add("facilityNames");
    if(this.facilityTelecoms == null || this.facilityTelecoms.isEmpty()) errors.add("facilityTelecoms");
...
public Document getCDA() throws ParserConfigurationException {
    ...
    CDALDOBuilder.addHeader(doc,this.oid,this.status,this.effectiveTimeDate,this.confidentialityCodeValue,this.setOid,this.versionNumberValue,
                            ...
                            this.custodianOrganizationAddress,this.custodianPhoneNumber,this.informationRecipientId,this.informationRecipientName,
