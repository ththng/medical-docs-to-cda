...
public class CodeSearchManager {
    ...
    private static final String ICD9_API_URL = "https://clinicaltables.nlm.nih.gov/api/icd9cm_dx/v3/search"; // Cambia con l'URL del server FHIR se diverso
    ...
    public static String searchICD9ByTerm(String term) {
        ...
        try {
            ...
            for (int i = 0; i < codes.length(); i++) {
                ...
                // Se è il primo codice o se la descrizione corrente è più corta di quella precedente, aggiorna
